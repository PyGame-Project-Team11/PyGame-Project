...
backgrounds = [
    pygame.transform.scale(pygame.image.load(image['image']), (WIDTH, HEIGHT))
    for image in background_list
]
...
while running:
    ...
    if not greeting:
        ...
        screen.blit(rules_button_surf,
                    (rules_button.x + 25, rules_button.y + 17))
